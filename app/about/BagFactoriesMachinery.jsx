...
const data = {
  hero: {
    en: { title: "Advanced Machinery in Our Cloth Bag Factories", subtitle: "High-speed automation & precision tools for plastic, non-woven, paper & leather bags – powered by our dual China & Vietnam bases." },
    zh: { title: "我们布袋工厂的先进设备", subtitle: "高速自动化与精密工具，生产塑料、无纺布、纸袋及皮革手袋——由中国与越南双基地驱动。" }
  },
  factories: {
    title: { en: "Our Two Production Bases", zh: "两大生产基地" },
    desc: { en: "Same OEM/ODM services, unified quality system — flexible capacity from China & Vietnam.", zh: "同一OEM/ODM服务，统一质量体系——中国+越南双基地灵活产能。" },
    china: {
  ...
  machinery: [
    {
      ...
      desc: { en: "High-speed lines for shopping & garbage bags", zh: "高速生产线，生产购物袋与垃圾袋" },
      color: "from-blue-600 to-indigo-700",
      machines: [
        { name: { en: "Film Blowing Machine", zh: "吹膜机" }, desc: { en: "Extrudes PE film rolls", zh: "挤出PE薄膜卷材" }, dummyImg: "https://via.placeholder.com/600x400/1e40af/ffffff?text=Film+Blowing" },
        { name: { en: "T-Shirt Bag Making Machine", zh: "背心袋制袋机" }, desc: { en: "Cuts & seals vest-style bags", zh: "切割并热封背心袋" }, dummyImg: "https://via.placeholder.com/600x400/1e3a8a/ffffff?text=T-Shirt+Bag" },
        { name: { en: "Flexo Printing Machine", zh: "柔版印刷机" }, desc: { en: "Prints logos on film", zh: "在薄膜上印刷logo" }, dummyImg: "https://via.placeholder.com/600x400/312e81/ffffff?text=Flexo+Printing" }
      ]
    },
    {
      ...
      machines: [
        { name: { en: "Fully Automatic Non-Woven Bag Making Machine", zh: "全自动无纺布制袋机" }, desc: { en: "Ultrasonic sealing, handle attachment", zh: "超声波密封+手柄自动附着" }, dummyImg: "https://via.placeholder.com/600x400/065f46/ffffff?text=Non-Woven+Bag" },
        { name: { en: "D-Cut / Box Bag Machine", zh: "D型/方底袋机" }, desc: { en: "Makes shaped shopping bags", zh: "生产造型购物袋" }, dummyImg: "https://via.placeholder.com/600x400/047857/ffffff?text=D-Cut+Bag" }
      ]
    },
    {
      ...
      machines: [
        { name: { en: "Square Bottom Paper Bag Machine", zh: "方底纸袋机" }, desc: { en: "Forms & glues square-bottom bags", zh: "成型并粘合方底纸袋" }, dummyImg: "https://via.placeholder.com/600x400/c2410c/ffffff?text=Paper+Bag" }
      ]
    },
    {
      category: { en: "Leather / Fashion Bag Production", zh: "皮革/时尚手袋生产" },
      desc: { en: "Premium handbags & totes", zh: "高端手袋与托特包" },
      color: "from-purple-600 to-pink-700",
      machines: [
        { name: { en: "Leather Cutting & Skiving Machine", zh: "皮革切割与削边机" }, desc: { en: "Precise panel cutting", zh: "精确切割皮革面板" }, dummyImg: "https://via.placeholder.com/600x400/7c3aed/ffffff?text=Leather+Cutting" },
        { name: { en: "Heavy-Duty Walking Foot Sewing Machine", zh: "重型行走压脚缝纫机" }, desc: { en: "Stitches thick leather", zh: "缝制厚皮革" }, dummyImg: "https://via.placeholder.com/600x400/ec4899/ffffff?text=Sewing+Machine" }
      ]
    }
  ]
};
      ...
      <section className="py-16 bg-gradient-to-b from-slate-50 to-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900">{factories.title[isEn ? "en" : "zh"]}</h2>
            <p className="mt-4 text-lg text-gray-600">{factories.desc[isEn ? "en" : "zh"]}</p>
          </div>
                  ...
                  <Card className="overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-500 border-0">
                    <div className="relative aspect-[16/9] bg-gradient-to-br from-amber-800 to-amber-950">
                      ...
                      <Badge className="absolute bottom-6 left-6 text-xl px-6 py-3 bg-white/95 text-gray-900 shadow-lg">
                        <Factory className="mr-3 h-6 w-6" /> {factory.name[isEn ? "en" : "zh"]}
                      </Badge>
                    </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900">Key Cloth Bag Machines</h2>
          </div>
            ...
            {machinery.map((cat, idx) => (
              ...
              >
                <Card className="overflow-hidden shadow-2xl border-0">
                  <CardHeader className={`bg-gradient-to-r ${cat.color} text-white py-8`}>
                    <CardTitle className="text-2xl">{cat.category[isEn ? "en" : "zh"]}</CardTitle>
                  ...
                  <CardContent className="p-8">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mt-8">
                      {cat.machines.map((m, i) => (
                        <div key={i} className="relative rounded-lg overflow-hidden shadow-md hover:shadow-xl transition">
                          <img
                            src={m.dummyImg}
